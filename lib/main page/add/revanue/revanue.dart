...
import 'package:vaultora_inventory_app/main%20page/add/addfiles/addpage/add_pages/revanue_container.dart';
import 'package:vaultora_inventory_app/main%20page/add/productfiles_sub/appbar.dart';
import 'package:vaultora_inventory_app/main%20page/add/revanue/details/monitor.dart';
import 'package:vaultora_inventory_app/main%20page/add/revanue/revanue_sub/revanue.dart';
...
class _RevanuePageState extends State<RevanuePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const MyAppBarTwo(titleText: 'Revenue'),
      body: Stack(
        children: [
          Padding(
