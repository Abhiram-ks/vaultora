...
import 'package:vaultora_inventory_app/screen_dashboard/records/sales/details_sales/details_sale_page.dart';
import 'package:vaultora_inventory_app/screen_dashboard/records/sales/filtering_sales/clear_bottom_sale.dart';
import 'package:vaultora_inventory_app/screen_dashboard/records/sales/subfiles_sales/sales_card.dart';
import 'package:vaultora_inventory_app/screen_dashboard/records/sales/filtering_sales/search_sale.dart';

import '../../../../db/helpers/salefuction.dart';
import '../../../common/appbar.dart';
import '../filtering_sales/sale_filter.dart';
...
void _applyDateFilters(DateTime? startDate, DateTime? endDate) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: MyAppBarTwo(titleText: 'Sales Record',bgColor: inside,),
